(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["grid-grid-module"], {
    ...
    /***/
    function srcAppLayoutGridGridRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLayoutGridGridComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      GridComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 142,
        vars: 3,
        consts: [[3, "heading", "icon"], [1, "row"], [1, "col-xl-12", "text-xs-center"], [1, "card", "mb-3"], [1, "card-body"], [1, "col-xl-6", "text-xs-center"], [1, "col-xl-4", "text-xs-center"], [1, "col-xl-3", "text-xs-center"], [1, "col-xl-2", "text-xs-center"], [1, "col-xl-1", "text-xs-center"], [1, "col-xl-8", "text-xs-center"]],
    ...
    /***/
    function srcAppLayoutGridGridModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
