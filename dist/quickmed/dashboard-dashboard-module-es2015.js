...
ChatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ChatComponent, selectors: [["app-chat"]], decls: 90, vars: 0, consts: [[1, "chat-panel", "card", "card-default"], [1, "card-header"], [1, "fa", "fa-comments", "fa-fw"], ["ngbDropdown", "", 1, "pull-right"], ["ngbDropdownToggle", "", 1, "btn", "btn-secondary", "btn-sm"], [1, "caret"], [1, "dropdown-menu", "dropdown-menu-right"], ["role", "menuitem"], ["href", "#", 1, "dropdown-item"], [1, "fa", "fa-refresh", "fa-fw"], [1, "fa", "fa-check-circle", "fa-fw"], [1, "fa", "fa-times", "fa-fw"], [1, "divider", "dropdown-divider"], [1, "fa", "fa-clock-o", "fa-fw"], [1, "divider"], [1, "fa", "fa-sign-out", "fa-fw"], [1, "card-body"], [1, "chat"], [1, "left", "clearfix"], [1, "chat-img", "pull-left"], ["src", "http://placehold.it/50/55C1E7/fff", "alt", "User Avatar", 1, "img-circle"], [1, "chat-body", "clearfix"], [1, "header"], [1, "primary-font"], [1, "pull-right", "text-muted"], [1, "right", "clearfix"], [1, "chat-img", "pull-right"], ["src", "http://placehold.it/50/FA6F57/fff", "alt", "User Avatar", 1, "img-circle"], [1, "text-muted"], [1, "pull-right", "primary-font"], [1, "card-footer"], [1, "input-group"], ["id", "btn-input", "type", "text", "placeholder", "Type your message here...", 1, "form-control", "input-sm"], [1, "input-group-btn"], ["id", "btn-chat", 1, "btn", "btn-warning", "btn-sm"]], template: function ChatComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _chat_chat_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../chat/chat.component */ "./src/app/layout/chat/chat.component.ts");
...
NotificationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NotificationComponent, selectors: [["app-notification"]], decls: 58, vars: 0, consts: [[1, "card-body"], [1, "list-group"], ["href", "#", 1, "list-group-item", "clearfix", "d-block"], [1, "fa", "fa-comment", "fa-fw"], [1, "float-right", "text-muted", "small"], [1, "fa", "fa-twitter", "fa-fw"], [1, "fa", "fa-envelope", "fa-fw"], [1, "fa", "fa-tasks", "fa-fw"], [1, "fa", "fa-upload", "fa-fw"], [1, "fa", "fa-bolt", "fa-fw"], [1, "fa", "fa-warning", "fa-fw"], [1, "fa", "fa-shopping-cart", "fa-fw"], [1, "fa", "fa-money", "fa-fw"], ["href", "#", 1, "btn", "btn-default", "btn-block"]], template: function NotificationComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
/* harmony import */ var _shared_modules_stat_stat_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/modules/stat/stat.component */ "./src/app/shared/modules/stat/stat.component.ts");
/* harmony import */ var _components_timeline_timeline_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/timeline/timeline.component */ "./src/app/layout/dashboard/components/timeline/timeline.component.ts");
/* harmony import */ var _components_notification_notification_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/notification/notification.component */ "./src/app/layout/dashboard/components/notification/notification.component.ts");
...
function DashboardComponent_8_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const slider_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], decls: 35, vars: 19, consts: [[1, "text-muted"], [1, "row"], [1, "col-md-12"], [4, "ngFor", "ngForOf"], [1, "col-xl-3", "col-lg-6"], [3, "bgClass", "icon", "count", "label"], [3, "type", "close", 4, "ngFor", "ngForOf"], [1, "col-lg-8"], [1, "card", "card-default"], [1, "card-header"], [1, "fa", "fa-clock-o", "fa-fw"], [1, "col-lg-4"], [1, "card", "card-default", "mb-3"], [1, "fa", "fa-bell", "fa-fw"], ["ngbSlide", ""], ["alt", "Random first slide", "width", "100%", 1, "img-fluid", "mx-auto", "d-block", 3, "src"], [1, "carousel-caption"], [3, "type", "close"]], template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DashboardModule, { declarations: [_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"],
        _components__WEBPACK_IMPORTED_MODULE_5__["TimelineComponent"],
        _components__WEBPACK_IMPORTED_MODULE_5__["NotificationComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbCarouselModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbAlertModule"],
        _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"],
        _shared__WEBPACK_IMPORTED_MODULE_6__["StatModule"]] }); })();
